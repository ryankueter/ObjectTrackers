...
public class TrackList<T>
{
    ...
    /// </summary>
    public List<ObjectTrackingChange> TrackedChanges { get; set; }
    ...
    /// </summary>
    private string[] Inclusions { get; set; }
    ...
    public bool HasChanges()
    {
        ...
        TrackedChanges = new List<ObjectTrackingChange>();
    ...
    public void Remove(T p)
    {
        ...
        _trackedList.RemoveAll(x => x.Value.Equals(p));
    }
